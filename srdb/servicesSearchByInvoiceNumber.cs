...
namespace srdb
{
    public partial class servicesSearchByInvoiceNumber : Form
    {
        private DBConnect dbConnect;
        public servicesSearchByInvoiceNumber()
        {
        ...
        private void servicesSearchByInvoiceNumber_Load(object sender, EventArgs e)
        {
            fillData();
        }
        ...
        private void txtSearch_TextChanged(object sender, EventArgs e)
        {
            ...
            dv.RowFilter = string.Format("invoice_number LIKE '%{0}%'", txtSearch.Text);
