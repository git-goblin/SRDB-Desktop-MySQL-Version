...
namespace srdb
{
    public partial class servicesSearchByRegistration : Form
    {
        private DBConnect dbConnect;
        public servicesSearchByRegistration()
        {
        ...
        private void servicesSearchByRegistration_Load(object sender, EventArgs e)
        {
            fillData();
        }
        ...
        private void txtSearch_TextChanged(object sender, EventArgs e)
        {
            ...
            dv.RowFilter = string.Format("registration LIKE '%{0}%'", txtSearch.Text);
